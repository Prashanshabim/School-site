...
add_action( 'init', 'custom_teachers' );
/**
 * Register a Custom post type for.
 */
function custom_teachers() {
	$labels = array(
		'name'               => _x( 'teachers', 'post type general name'),
		'singular_name'      => _x( 'teachers', 'post type singular name'),
		'menu_name'          => _x( 'teachers', 'admin menu'),
		'name_admin_bar'     => _x( 'teachers', 'add new on admin bar'),
		'add_new'            => _x( 'Add New', 'teachers'),
		'add_new_item'       => __( 'Name'),
		'new_item'           => __( 'New teachers'),
		'edit_item'          => __( 'Edit teachers'),
		'view_item'          => __( 'View teachers'),
